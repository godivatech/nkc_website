    ...
    >
      <div className="container mx-auto px-6 flex justify-between items-center">
        <Link href="/" className="flex items-center gap-2 z-50 relative">
          <img src={logo} alt="NKC Builders" className="h-10 w-auto" />
          <span className={cn("text-xl font-bold tracking-tighter", scrolled ? "text-primary" : "text-white")}>
            NKC Builders
          </span>
        </Link>
        ...
        {/* Mobile Toggle */}
        <button
          className={cn("md:hidden z-50 relative", scrolled ? "text-primary" : "text-white")}
